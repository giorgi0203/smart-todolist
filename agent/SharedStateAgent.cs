...
[SuppressMessage("Performance", "CA1812:Avoid uninstantiated internal classes", Justification = "Instantiated by TodoAgentFactory")]
internal sealed class SharedStateAgent : DelegatingAIAgent
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        firstRunOptions.ChatOptions.ResponseFormat = ChatResponseFormat.ForJsonSchema<TodoStateSnapshot>(
            schemaName: "TodoStateSnapshot",
            schemaDescription: "A response containing the current list of todos with their details");
